                    ...
                    <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-med_descripcion" name="med_descripcion" placeholder="Descripcion" >
                     ...
                     <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-med_abreviatura" name="med_abreviatura" placeholder="Abreviatura" >
