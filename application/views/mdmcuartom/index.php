                    ...
                    <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-mdm_descripcion" name="mdm_descripcion" placeholder="Descripcion" >
                     ...
                     <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-mdm_abreviatura" name="mdm_abreviatura" placeholder="Abreviatura" >
