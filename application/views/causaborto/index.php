                    ...
                    <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-cab_descripcion" name="cab_descripcion" placeholder="Descripcion" >
                     ...
                     <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-cab_abreviatura" name="cab_abreviatura" placeholder="Abreviatura" >
