                    ...
                    <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-raz_descripcion" name="raz_descripcion" placeholder="Descripcion" >
                     ...
                     <div class="row">
                        <section>
                            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                <input type="text" id="input-raz_abreviatura" name="raz_abreviatura" placeholder="Abreviatura" >
