...
class Estadoc extends CI_Controller {
    ...
    function datatable() {
        $this->datatables->select('id,etc_descripcion,etc_abreviatura,etc_estado')
                ->unset_column('id')
    ...
    public function json_getestadoc_id() {
    ...
    public function save(){
        if ($this->input->post()) {
            ...
            $obj->etc_descripcion = strtoupper($this->input->post("etc_descripcion"));
            $obj->etc_abreviatura = strtoupper($this->input->post("etc_abreviatura"));
            $obj->etc_estado = 1;
